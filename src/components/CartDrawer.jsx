              ...
              <div className="flex-1 overflow-y-auto p-6">
                {cart.length === 0 ? (
                  <div className="flex h-full flex-col items-center justify-center text-center">
                    ...
                    <p className="mb-2 text-lg font-semibold text-gray-900">Tu carrito está vacío</p>
                    <p className="mb-6 text-sm text-gray-600">Añade productos para empezar</p>
                    <Link
                      href="/tienda"
                      onClick={() => setIsOpen(false)}
              ...
              {cart.length > 0 && (
                <div className="border-t border-gray-200 p-6">
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-[#224621]">{getTotal().toFixed(2)}€</span>
                  </div>
                  <Link
                    href="/checkout"
                    onClick={() => setIsOpen(false)}
